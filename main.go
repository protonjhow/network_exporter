...
func startServer() {
	...
	reg.MustRegister(&collector.MTR{Monitor: monitorMTR, HistogramBuckets: sc.Cfg.Conf.HistogramBuckets})
	reg.MustRegister(&collector.PING{Monitor: monitorPING, HistogramBuckets: sc.Cfg.Conf.HistogramBuckets})
	reg.MustRegister(&collector.TCP{Monitor: monitorTCP, HistogramBuckets: sc.Cfg.Conf.HistogramBuckets})
